...
- Demo canlı: https://regular07.github.io/standart-paket/
- **Sırada:** logo/görsel kimlik → ana sayfa inşası → CV sayfası → müşteri demo'su
...
- 🧠 [[🧠 500-Knowledge/|Bilgi]]
- 🔮 [[🔮 850-Companion/Core|Dündar Dinç]]
...
> Bu notu Obsidian'da açık bırakıp kapatırsan, Obsidian bir dahaki açılışında otomatik
> olarak buraya döner (Obsidian'ın kendi davranışı, eklenti gerekmez).
